...
//           </li>
//           <li>
//             <Link to="/tasks" className="text-white hover:text-gray-200 transition duration-300 border-b-2 border-transparent hover:border-white pb-1">Tasks</Link>
//           </li>
//           {/* Show profile link or logo if user is logged in */}
//           {currentUser && (
//             <li>
//               <Link to="/profile" className="text-white hover:text-gray-200 transition duration-300 border-b-2 border-transparent hover:border-white pb-1">Profile</Link>
//             </li>
//           )}
//           {!currentUser && (
//             <li>
...
//           {currentUser && (
//             <li>
//               <button className="text-white hover:text-gray-200 transition duration-300 border-b-2 border-transparent hover:border-white pb-1" onClick={onLogout}>Logout</button>
//             </li>
//           )}
//         </ul>
...
//               </li>
//               <li>
//                 <Link to="/tasks" className="text-white transition duration-300 py-2 px-4 rounded-md hover:bg-indigo-700" onClick={closeMenu}>Tasks</Link>
//               </li>
//               {/* Show profile link or logo if user is logged in */}
//               {currentUser && (
//                 <li>
//                   <Link to="/profile" className="text-white transition duration-300 py-2 px-4 rounded-md hover:bg-indigo-700" onClick={closeMenu}>Profile</Link>
//                 </li>
//               )}
//               {!currentUser && (
//                 <li>
...
//               {currentUser && (
//                 <li>
//                   <button className="text-white transition duration-300 py-2 px-4 rounded-md hover:bg-indigo-700" onClick={() => { closeMenu(); onLogout(); }}>Logout</button>
//                 </li>
//               )}
//             </ul>
//           </div>
