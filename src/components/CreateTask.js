        ...
        <div className="p-4 border border-gray-300 rounded-lg space-y-4">
          ...
          <div className="flex flex-col">
            ...
            <select
              ...
              onChange={handlePriorityChange}
              className
              ="rounded-md border border-gray-300 p-3 focus:outline-none focus:border-blue-500 w-full sm:w-1/2 transition duration-300 ease-in-out hover:border-blue-500 appearance-none"
              >
                <option disabled value="">
                  Select Priority
                </option>
